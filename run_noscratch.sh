...
#
# example usage: ./run_noscratch.sh tenday10mem0 010 0 SRoff10 10day

set -e

if (($# != 5)); then
	echo 'Usage: '${0}' experiment name, restart no., choice of SST anomaly forcing (0 = none, 1=El Nino), number of significand bits (52 = double, 23 = single, 10 = half), namelist (e.g. 10daySPPT)' 1>&2
    exit 1
fi
