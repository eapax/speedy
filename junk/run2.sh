...
# Define those experiments in output folder whose restart files may be used for initial conditions
# A good convention is to always start these with a zero 
initial_conditions='^(003|004|005)$'
