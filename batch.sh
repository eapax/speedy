...
nohup time ./run.sh speedyoneBREAKDOWN_L2_50_RNcoupling_10year      010 2 SRoff52_cpl       10year4CO2 > output/speedyoneBREAKDOWN-L2_50_RNcpl_10year.out &
nohup time ./run.sh speedyoneBREAKDOWN_L2_50_RNtimestep_10year      010 2 SRoff52_timeint   10year4CO2 > output/speedyoneBREAKDOWN-L2_50_RNtimeint_10year.out &
nohup time ./run.sh speedyoneBREAKDOWN_L2_50_RNcompound_10year      010 2 SRoff52_compound  10year4CO2 > output/speedyoneBREAKDOWN-L2_50_RNcompound_10year.out &

#nohup time ./run.sh speedyoneHALF_L2_10H_SR_10year                  010 2 10H               10year4CO2 > output/speedyoneHALF_L2_10H_SR_10year.out &
#nohup time ./run.sh speedyoneHALF_L2_10H_RN_10year                  010 2 SRoff10H          10year4CO2 > output/speedyoneHALF_L2_10H_RN_10year.out &
