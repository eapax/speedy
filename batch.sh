...
nohup time ./run.sh speedyoneV2_L2_50_RNCOUPLER_1month_stg2 010 2 SRoff50   1month > output/speedyoneV2-L2_50_RNCOUPLER_1month.out &
nohup time ./run.sh speedyoneV2_L2_10_RNCOUPLER_1month_stg2 010 2 SRoff10   1month > output/speedyoneV2-L2_10_RNCOUPLER_1month.out &
