...
nohup time ./run.sh throwaway_L2_50_RN 010 2 SRoff50 1year > output/throwaway-L2_50_RN_1year_.out &
nohup time ./run.sh throwaway_L2_10_RN 010 2 SRoff10 1year > output/throwaway-L2_10_RN_1year_.out &
nohup time ./run.sh throwaway_L2_10_SR 010 2 10      1year > output/throwaway-L2_10_SR_1year_.out &
nohup time ./run.sh throwaway_L2_10_RNTIMESTEPPING50 010 2 SRoff10_rp_timestepping50_ 1year > output/throwaway-L2_10_RN_1year_RP3_50.out &
